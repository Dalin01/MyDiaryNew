...
public class DialogUpdateName extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        textEntryView = inflater.inflate(R.layout.dialog_update_name, null);
    ...
    public void update() {
        EditText new_name = (EditText) textEntryView.findViewById(R.id.my_name);

        String my_new_name = new_name.getText().toString();


        if (my_new_name.trim().equals("")) {
            ...
            values.put(DiaryContract.DiaryEntry.COLUMN_NAME, my_new_name);
            String selection = DiaryContract.DiaryEntry._ID + " = ?";
            String[] selectionArgs = {"1"};
            try{
